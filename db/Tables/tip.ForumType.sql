...
(
[Id] [uniqueidentifier] NOT NULL CONSTRAINT [DF_ForumType_Id] DEFAULT (newid()),
...
[EndDate] [date] NULL,
[CreatedById] [uniqueidentifier] NOT NULL CONSTRAINT [DF_ForumType_CreatedById] DEFAULT (user_name()),
[CreatedOn] [datetime2] NOT NULL CONSTRAINT [DF_ForumType_CreatedOn] DEFAULT (getutcdate()),
