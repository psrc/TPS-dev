...
[IsActive] [bit] NOT NULL CONSTRAINT [DF_ProgrammedFunding_Pending_IsActive] DEFAULT ((1)),
...
GO
ALTER TABLE [tip].[ProgrammedFunding_Pending] ADD CONSTRAINT [FK_ProgrammedFunding_Pending_AwardReference] FOREIGN KEY ([AwardReferenceId]) REFERENCES [tip].[AwardReference] ([Id])
GO
