...
[SubAwardReference] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[AwardYear] [smallint] NOT NULL,
[AgeOfFunds] [smallint] NULL,
[ForumTypeId] [uniqueidentifier] NULL,
[DistributionTypeId] [uniqueidentifier] NOT NULL,
[AgencyId] [uniqueidentifier] NOT NULL,
[ProjectId] [uniqueidentifier] NULL,
[PhaseTypeId] [uniqueidentifier] NULL,
[FundSourceTypeId] [uniqueidentifier] NOT NULL,
[FundAmount] [bigint] NOT NULL,
[Notes] [nvarchar] (max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[IsActive] [bit] NOT NULL CONSTRAINT [DF_AwardReference_IsActive] DEFAULT ((1)),
