...
[CreatedById] [uniqueidentifier] NOT NULL CONSTRAINT [DF__ProjectIm__Creat__2799C73C] DEFAULT (user_name()),
[CreatedOn] [datetime2] NOT NULL CONSTRAINT [DF__ProjectIm__Creat__288DEB75] DEFAULT (getutcdate()),
